...
- (void)layoutSubviews {
    ...
    if (self.sent == YES) {
        ...
        ballonViewFrame = CGRectMake(self.frame.size.width - (textSize.width + 2*textMarginHorizontal) -55.0f, timeLabelFrame.size.height, textSize.width + 2*textMarginHorizontal, textSize.height + 2*textMarginVertical);
        
        messageLabelFrame = CGRectMake(self.frame.size.width - (textSize.width + 2*textMarginHorizontal) -40.0f,   ballonViewFrame.origin.y + textMarginVertical, textSize.width, textSize.height);
        ...
        messageLabelFrame = CGRectMake(70.0f, ballonViewFrame.origin.y + textMarginVertical, textSize.width, textSize.height);
        
        avatarImageFrame = CGRectMake(5.5f, timeLabelFrame.size.height, 50.0f, 50.0f);
    }
